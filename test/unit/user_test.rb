...
class UserTest < ActiveSupport::TestCase  
  ...
  public
    ...
    test "should require and have errors on fullname" do
      assert_no_difference 'User.count' do
        u = create_user(:fullname => nil)
        assert u.errors.on(:fullname)
      end
    end
